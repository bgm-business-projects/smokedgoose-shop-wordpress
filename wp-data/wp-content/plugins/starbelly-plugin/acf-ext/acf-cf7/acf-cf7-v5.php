...
if( ! class_exists( 'acf_field_starbelly_cf7' ) ) :

class acf_field_starbelly_cf7 extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __( 'Contact Form 7', 'starbelly-plugin' );
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __( 'Allow Null?', 'starbelly-plugin' ),
			'type'			=> 'radio',
			'name'			=> 'allow_null',
			'choices' =>  array(
			  	1 =>  __( 'Yes', 'starbelly-plugin' ),
			  	0 =>  __( 'No', 'starbelly-plugin' ),
			),
			'layout'  =>  'horizontal'
		));

		acf_render_field_setting( $field, array(
			'label'			=> __( 'Select Multiple?', 'starbelly-plugin' ),
			'type'			=> 'radio',
			'name'			=> 'multiple',
			'choices' =>  array(
				1 =>  __( 'Yes', 'starbelly-plugin' ),
		...
		acf_render_field_setting( $field, array(
			'label'			=> __( 'Disable Forms?', 'starbelly-plugin' ),
			'instructions'	=> __( 'User will not be able to select these forms', 'starbelly-plugin' ),
			'type'			=> 'select',
			'name'			=> 'disable',
			'multiple'		=> '1',
			'allow_null'  =>  '0',
