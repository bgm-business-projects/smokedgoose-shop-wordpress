...
/**
 * Starbelly Restaurant Menu List Widget.
 *
 * @since 1.0
 */
class Starbelly_Restaurant_Menu_List_Widget extends Widget_Base {

	public function get_name() {
		return 'starbelly-restaurant-menu-list';
	}

	public function get_title() {
		return esc_html__( 'Restaurant Menu List', 'starbelly-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw' =>  sprintf( __( 'All categories and additional categories fields you can edit in <a href="%s" target="_blank">Restaurant -> Categories</a>', 'starbelly-plugin' ), admin_url( 'edit-tags.php?taxonomy=restaurant_menu_categories&post_type=restaurant_menu' ) ),
		...
		$this->add_control(
			...
			[
				'type' => \Elementor\Controls_Manager::RAW_HTML,
				'raw' =>  sprintf( __( 'All restaurant menu items and additional item fields you can edit in <a href="%s" target="_blank">Restaurant -> Menu Items</a>', 'starbelly-plugin' ), admin_url( 'edit.php?post_type=restaurant_menu' ) ),
				'content_classes' => 'elementor-descriptor',
			]
		);
	...
	protected function render() {
      ...
      $attr_classes .= ' attr-rating-false';
		...
		$category_desc = get_field( 'full_description', 'restaurant_menu_categories_' . $category->term_id );
...
Plugin::instance()->widgets_manager->register( new Starbelly_Restaurant_Menu_List_Widget() );
